...
public class SqliteCodeTable {
	...
	private final String DATABASE_PATH = "/sdcard/";
	...
	public SQLiteDatabase openDatabase() {
		...
		try {
			...
			System.out.print("打开数据库:" + databaseFilename);
			...
			if (!(new File(databaseFilename)).exists()) {
				System.out.print("数据库不存在，新建数据库" + databaseFilename + context);
...
//			System.out.print("数据库需要更新：" + old_ver + "-->" + new_ver);
//			try {
